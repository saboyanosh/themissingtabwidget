...
public class TheMissingTabWidgetDemo extends TheMissingTabActivity {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        final TheMissingTabSpec oneSpec = tabHost
                .newTabSpec("One")
        ...
        final TheMissingTabSpec twoSpec = tabHost.newTabSpec("Two")
                .setIndicator("Two").setContent(twoIntent);
        tabHost.addTab(twoSpec);

        final Intent threeIntent = new Intent().setClass(this,
                ActivityThree.class);
        final TheMissingTabSpec threeSpec = tabHost.newTabSpec("Three")
